...
use pdf_oxide::{
    ...
    geometry::Rect,
    writer::{
        document_builder::{DocumentBuilder, DocumentMetadata},
        streaming_table::{CellAlign, StreamingColumn, StreamingTableConfig},
    },
    PdfDocument,
};
...
fn feature_pdf_ua_accessible_image(out_dir: &PathBuf) -> Result<()> {
    ...
    let white_png: &[u8] = &[
        ...
        0xf8, 0xcf, 0xc0, 0x00, 0x00, 0x00, 0x02, 0x00, 0x01, 0xe2, 0x21, 0xbc, 0x33, 0x00, 0x00,
