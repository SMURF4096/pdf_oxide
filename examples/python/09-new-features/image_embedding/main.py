...
RGBA_PNG = bytes(
    [
        ...
        0x78, 0x9C, 0x63, 0xF8, 0xCF, 0xC0, 0xD0, 0x00,
        0x00, 0x04, 0x81, 0x01, 0x80, 0x2C, 0x55, 0xCE, 0xB0,
...
page.at(72, 420).paragraph("Transparent PNG below — rendered without diagonal-line artifact (#450).")
